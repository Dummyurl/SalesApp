...
public class ExpenseDetailsAdapter extends RecyclerView.Adapter<ExpenseDetailsAdapter.MyViewHolder> {
    ...
    public ExpenseDetailsAdapter(Context ctx, List<GetExpenseDetailsPOJO.Datum> getExpenseDetailList, SetListSize setListSize) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.expense_details_list_item, parent, false);
