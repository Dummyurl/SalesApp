 ...
 */
public class EditCustomerDetailsTwo extends BaseFragment {
    ...
    public EditCustomerDetailsTwo() {
        // Required empty public constructor
    }

    public static EditCustomerDetailsTwo newInstance(CustomerModel customerModel, GetCustomerDetailsPOJO.Datum dataCustomer) {
        EditCustomerDetailsTwo fragment = new EditCustomerDetailsTwo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.add_customer_details_two, container, false);
