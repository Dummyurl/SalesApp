...
public class AddCustomerDialogue extends BaseDialog implements ViewPagerChangeInterface {
    public static final String TAG = AddCustomerDialogue.class.getSimpleName();
    ...
    public static AddCustomerDialogue newInstance() {
        AddCustomerDialogue fragment = new AddCustomerDialogue();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbar_title.setText(getString(R.string.add_new_customer));
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(AddCustomerDetailsOne.newInstance(customerModel), getString(R.string.add_text_one_by_four));
        //adapter.addFragment(AddCustomerDetailsTwo.newInstance(customerModel), getString(R.string.add_text_two_by_four));
        adapter.addFragment(AddCustomerDetailsThree.newInstance(customerModel), getString(R.string.add_text_two_by_four));
        adapter.addFragment(AddCustomerDetailsFour.newInstance(customerModel), getString(R.string.add_text_three_by_four));
        adapter.addFragment(AddCustomerDetailsFive.newInstance(customerModel), getString(R.string.add_text_four_by_four));
        adapter.addFragment(AddCustomerDetailsSix.newInstance(customerModel), getString(R.string.add_text_five_by_four));
