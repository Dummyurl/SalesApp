...
public class RecyclerItemTouchHelperExpense extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerItemTouchHelperExpense(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((MyExpenseAdapter.MyViewHolder) viewHolder).viewForeground;
