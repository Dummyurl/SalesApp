 ...
 */
public class AddCustomerDetailsTwo extends BaseFragment {
    ...
    public AddCustomerDetailsTwo() {
        // Required empty public constructor
    }

    public static AddCustomerDetailsTwo newInstance(CustomerModel customerModel) {
        AddCustomerDetailsTwo fragment = new AddCustomerDetailsTwo();
