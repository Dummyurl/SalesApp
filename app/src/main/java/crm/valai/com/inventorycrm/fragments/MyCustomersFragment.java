...
public class MyCustomersFragment extends BaseFragment {
    public static final String TAG = MyCustomersFragment.class.getSimpleName();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ManageCustomersFragment(), getString(R.string.manage_customer));
        adapter.addFragment(new AdditionalDetailsFragment(), getString(R.string.additional_details));
