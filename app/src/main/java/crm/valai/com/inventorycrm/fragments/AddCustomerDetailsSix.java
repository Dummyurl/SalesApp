 ...
 */
public class AddCustomerDetailsSix extends BaseFragment {
    public static final String TAG = AddCustomerDetailsSix.class.getSimpleName();
    ...
    public AddCustomerDetailsSix() {
        // Required empty public constructor
    }

    public static AddCustomerDetailsSix newInstance(CustomerModel customerModel) {
        AddCustomerDetailsSix fragment = new AddCustomerDetailsSix();
...
//        }
    ...
    private void addCustomer(final Integer status) {
        ...
        JSONObject jsonObject = jsonClient.insertUpdateCustomerDetailsJson(logInResList.get(0).getCompId(), INSERT_CUSTOMER, logInResList.get(0).getLoginId(),
                logInResList.get(0).getToken(), 0, logInResList.get(0).getStaffId(), customerModel.getReferredBy(), customerModel.getContactPersonName(),
